...
function ocultarPanel(primera, segunda, tercera, cuarta, quinta, sexta, septima, octava) {
...
<div id="cabecera"><strong>RESULTAT DE L'ANÀLISI<br/>
- Període de <?php 
$fecha1=$_GET["fecha1"];
$fecha2=$_GET["fecha2"];
...
//Declaramos el número de estudiantes que participan en la conversacion
...
<tr>
<td valign="top">
	<div id="metricasGlobales" class="solapa" style="cursor: pointer;" onClick="ocultarPanel(false,true,true,true,true,true,true,true);">
    <img src="img/equipo.png"><br/>
    <strong>IND./MÈTRIQUES<BR/>GLOBALS</strong>
	</div>
    
	<div class="solapa" style="cursor: pointer;" onClick="ocultarPanel(true,false,true,true,true,true,true,true);">
    <img src="img/campana.png" style="margin-top:5px;"><br/>
    <strong>ALERTES</strong>
	</div>
    
	<div id="metricasIndividuales" class="solapa" style="cursor: pointer;" onClick="ocultarPanel(true,true,false,true,true,true,true,true);">
    <img src="img/estudiante.png"><br/>
    <strong>IND./MÈTRIQUES<BR/>INDIVIDUALS</strong>
	</div>
    
	<div id="clasificaciones" class="solapa" style="cursor: pointer;" onClick="ocultarPanel(true,true,true,false,true,true,true,true);">
    <img src="img/clasificaciones.png" style="margin-top:5px;"><br/>
    <strong>CLASSIFICACIONS</strong>
	</div>
    
	<div id="estudiantes" class="solapa" style="cursor: pointer;" onClick="ocultarPanel(true,true,true,true,false,true,true,true);">
    <img src="img/vista_estudiante.png" style="margin-top:5px;"><br/>
    <strong>VISTA ESTUDIANT</strong>
	</div>
    
	<div id="comparador" class="solapa" style="cursor: pointer;" onClick="ocultarPanel(true,true,true,true,true,false,true,true);">
	...
	<div id="feedbackCatalan" class="solapa" style="cursor: pointer;" onClick="ocultarPanel(true,true,true,true,true,true,false,true);">
    <strong>FEEDBACK<br />CATALÀ</strong><br/>
    <img src="img/bandera_catalana.png">
	</div>
    
	<div id="feedbackCastellano" class="solapa" style="cursor: pointer;" onClick="ocultarPanel(true,true,true,true,true,true,true,false);">
 ...
 ?>
	...
	<div id="panelAlertas" class="panelDerecho"> <!-- AQUÍ EMPIEZA EL PANEL DE ALERTAS -->
		...
		<table cols="2" align="center" style="font-family:Verdana, Geneva, sans-serif; font-size:11px;" cellspacing="0px" width="860px">
    		<tr>
            	<td align="center" colspan="2" height="35px" style="background: #CCC;">
                

                <div class="tituloAlerta"><strong>- Grau d'acompliment de l'objectiu de dispersió de la conversa -</strong></div>
                </td>
            </tr>
            <tr>
			...
			<?php
				...
				foreach ($mensajesPorEstudiante as $estudiante => $total) {
					if ($total==0) {
						echo "<tr><td></td><td height=\"25px\">- ".$estudiante."</td></tr>";
						$contador++;
					}
				}
				if ($contador==0) {
			...
			<?php
				...
				foreach ($mensajesPorEstudiante as $estudiante => $total) {
					if (($total>0) && ($total<$minimo)) {
						echo "<tr><td></td><td height=\"25px\">- ".$estudiante." <span style=\"color:#C00;\"><em>(".($minimo-$total)." missatge/s per superar el llindar)<br/><br/></em></span></td></tr>";
						$contador++;
					}
				}
				if ($contador==0) {
			...
			<?php
				...
				foreach ($mensajesPorEstudiante as $estudiante => $total) {
					if ($total>$maximo) {
						echo "<tr><td></td><td height=\"25px\">- ".$estudiante." <span style=\"color:#C00;\"><em>(".($total-$maximo)." missatge/s per sobre del llindar)<br/><br/></em></span></td></tr>";
						$contador++;
					}
				}
				if ($contador==0) {
...
echo "</td><td>".$adjuntosPorEstudiante[$estudiante];
if ($adjuntosPorEstudiante[$estudiante]>0) {
...
echo "</td><td>".$enlacesPorEstudiante[$estudiante];
...
?>
	...
	<div id="panelVistaEstudiante" class="panelDerecho"> <!-- AQUÍ EMPIEZA EL PANEL VISTA DE ESTUDIANTE -->
        ...
        <?php
			...
			foreach ($listaEstudiantes as $estudiante=>$valor){
				echo "<option value=\"http://www.paucasals.com/missatgesUOC/vistaEstudiante.php?carpeta=debates/seleccionado&amp;fecha1=".$fecha1."&amp;fecha2=".$fecha2."&amp;estudiante=".$estudiante."\">".$estudiante."</option>";
	...
	<div id="panelVistaComparador" class="panelDerecho"> <!-- AQUÍ EMPIEZA EL PANEL VISTA DE COMPARADOR DE ESTUDIANTE -->
        ...
        <?php
			...
			echo "<option value=\"http://www.paucasals.com/missatgesUOC/vistaEstudianteVacio.php\">(Selecciona)</option>";
			foreach ($listaEstudiantes as $estudiante=>$valor){
				echo "<option value=\"http://www.paucasals.com/missatgesUOC/vistaEstudianteVertical.php?carpeta=debates/seleccionado&amp;fecha1=".$fecha1."&amp;fecha2=".$fecha2."&amp;estudiante=".$estudiante."\">".$estudiante."</option>";
				//echo "<option value=\"".$estudiante."\">".$estudiante."</option>";
			}
			echo "</select>";
        ?>
...
ocultarPanel(false,true,true,true,true,true,true,true);
